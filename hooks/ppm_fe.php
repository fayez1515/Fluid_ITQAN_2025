<?php
	...
	function ppm_fe_init(&$options, $memberInfo, &$args) {

		return TRUE;
	}

	function ppm_fe_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	function ppm_fe_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	function ppm_fe_before_insert(&$data, $memberInfo, &$args) {

		return TRUE;
	}

	function ppm_fe_after_insert($data, $memberInfo, &$args) {

		return TRUE;
	}

	function ppm_fe_before_update(&$data, $memberInfo, &$args) {

		return TRUE;
	}

	function ppm_fe_after_update($data, $memberInfo, &$args) {

		return TRUE;
	}

	function ppm_fe_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {

		return TRUE;
	}

	function ppm_fe_after_delete($selectedID, $memberInfo, &$args) {

	}

	function ppm_fe_dv($selectedID, $memberInfo, &$html, &$args) {
		...
		<script>
			$j(function(){
				$j('#form-tabs').appendTo('#ppm_fe_dv_form');
				...
				$j('#id_fe').parents('.form-group').appendTo('#Print_Setting');			
	...
	function ppm_fe_csv($query, $memberInfo, &$args) {

		return $query;
	}
	function ppm_fe_batch_actions(&$args) {
